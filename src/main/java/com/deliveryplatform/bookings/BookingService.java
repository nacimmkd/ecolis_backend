...
public class BookingService {
    ...
    public BookingResponse create(BookingRequest request, UUID requesterId) {
        ...
        var requester = userService.getUserByIdOrThrow(requesterId);
        var booking = buildBooking(parcel, trip, requester);
    ...
    private void assertCancellationAllowed(Booking booking, UUID requesterId) {
        boolean isRequester = booking.getRequester().getId().equals(requesterId);
